<?php
	...
	if (isset($_POST['email']))
	{
		...
		$sekret = "secretkeykey z rechapty";
		...
		try 
		{
			...
			else
			{
				...
				if ($wszystko_OK==true)
				{
					...
					if ($polaczenie->query("INSERT INTO uzytkownicy VALUES (NULL, '$nick', '$login','$haslo_hash', '$email', 100, 100, 100, 10, 4)"))
					{
...
<body>
	...
	<form method="post">
		...
		<div class="g-recaptcha" data-sitekey="sitekey z rechapty"></div>
